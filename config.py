...
API_URL = getenv("API_URL", 'https://tgapi.xbitcode.com') ## E.G https://yt.okflix.
...
OWNER_ID = int(getenv("OWNER_ID", "5635324483"))

OWNER_USERNAME = getenv("OWNER_USERNAME","isamxyz")

BOT_USERNAME = getenv("BOT_USERNAME" , "StarXMusicBot")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/VIP-saksham/starxmusic",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "sam")
GIT_TOKEN = getenv(
    "GIT_TOKEN", ""
